...
const Chat = () => {
    ...
    return (
        <div className="hidden lg:block lg:w-1/4 xl:w-1/5">
            <div className="py-2 2xl:py-4 px-4 bg-gray-900 flex justify-between items-center font-bold">
            ...
            <div
                id="messageBox"
                className="px-2 w-full lg-chat-height 2xl:2xl-chat-height bg-gray-800 flex flex-col overflow-y-scroll scrollbar"
            >
